...
const PrivacyPolicy = props => {
  return (
    <div className="privacy-policy-container">
      <h2>Compliance.ai Privacy Policy</h2>
      <p>
        This privacy policy discloses the privacy practices for Compliance.ai. This privacy policy
        applies solely to information collected by this web site. It will notify you of the
        following:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        time by contacting us via the email address or phone number given on our website. You may
        also contact us at anytime for the following reasons:
      </p>
      <ul>
      ...
      <p>
        ...
        address). This information is used to contact you about the products/services on our site in
        which you have expressed interest. At your option, you may also provide demographic
        information (such as gender or age) about yourself, but it is not required.
      </p>
      <h3>Cookies</h3>
      <p>
        We may use "cookies" on this site. A cookie is a piece of data stored on a site visitor's
        hard drive to help us improve your access to our site and identify repeat visitors to our
        site. For instance, when we use a cookie to identify you, you would not have to log in a
        password more than once, thereby saving time while on our site. Cookies can also enable us
        to track and target the interests of our users to enhance the experience on our site. Usage
        of a cookie is in no way linked to any personally identifiable information on our site.
      </p>
      <p>
        Some of our business partners may use cookies on our site (for example, analytics and
        tracking). However, we have no access to or control over these cookies.
      </p>
      <h3>Sharing</h3>
      <p>
        We share aggregated demographic information with our partners and users. This is not linked
        to any personal information that can identify any individual person. This information may be
        used to improve the product (for example, input to relevance ranking in search results).
      </p>
      <h3>Links</h3>
      <p>
        This web site contains links to other sites. Please be aware that we are not responsible for
      ...
      <p>
        ...
        immediately via email at <a href="mailto:support@compliance.ai">support@compliance.ai</a>
        .
      </p>
    </div>
  );
